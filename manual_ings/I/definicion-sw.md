...
- **Software de aprendizaje automático**: Popularmente conocido como inteligencia artificial o inteligencia artificial generativa, es un tipo de software no desarrollado: sus respuestas no son programadas de manera explícita o directa, sino que emergen a partir de conjunto inicial de reglas cuyos parametros se ajustan (*entrenamiento*) utilizando un proceso estadístico sobre un gran conjunto de datos.
